  ...
  return (
    <Card className="h-full flex flex-col">
      <CardHeader className="text-right">
        <CardTitle className="text-2xl font-black flex items-center justify-end gap-2">
          {springY.get().toFixed(0)} <span className="text-sm font-medium text-muted-foreground ms-1">ر.س</span>
          <Badge variant="secondary" className="bg-red-500/10 text-red-500 border-none ms-2">
            <TrendingDown className="h-4 w-4" />
            <span>-5.2%</span>
          </Badge>
        </CardTitle>
        <CardDescription>إيرادات السنة الماضية</CardDescription>
      </CardHeader>
