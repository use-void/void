  ...
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-8 py-10">
        <div className="relative">
            ...
            <div className="relative h-24 w-24  bg-green-500/10 flex items-center justify-center border border-green-500/20">
                <Sparkles className="h-10 w-10 text-green-500" />
            </div>
            <div className="absolute -bottom-2 -right-2 h-8 w-8 bg-green-500  flex items-center justify-center text-white ring-4 ring-background">
        ...
        <div className="w-full h-1.5 bg-muted  overflow-hidden max-w-[200px]">
             <div 
